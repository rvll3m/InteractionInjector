...
{
    public class SimDescriptionEx_Patch
    {
        ...
        [ReplaceMethod(typeof(NRaas.RelationshipPanelSpace.SimDescriptionEx), "OnPickFromPanel")]
        public static void OnPickFromPanel(SimDescription ths, UIMouseEventArgs eventArgs, GameObjectHit gameObjectHit)
        {
            ...
            Common.MethodStore sGetSendWooHootyTextDefinition = new Common.MethodStore("NRaasWoohooer", "NRaas.Woohooer", "GetSendWooHootyTextDefinition", new Type[] { typeof(SimDescription) });
                    ...
                    if (activeActor.InteractionQueue.CanPlayerQueue())
                    {
                        ...
                        try
                        {
                            ...
                            if (ths.CreatedSim != null)
                            {
                                ...
                                OnPickFromPanelEvent?.Invoke(eventArgs, gameObjectHit, interactions, ths.CreatedSim, ths);
                            }
                            ...
                            if (ths.IsHuman)
                            {
                                ...
                                if (activePhone != null)
                                {
                                    OnPickFromPanelEvent_Phone?.Invoke(eventArgs, gameObjectHit, interactions, activePhone, ths);
